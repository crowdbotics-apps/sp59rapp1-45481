...
class testConnector1ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTOR1_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTOR1_USERNAME
    BASE_URL = "https://api.sp59Rapp1.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTOR1"
